...
const BUNDLED_MANIFEST_BASELINE = {
  tag_name: 'b9702',
  assets: [
    { name: 'llama-b9702-bin-win-cpu-x64.zip' },
    { name: 'llama-b9702-bin-win-cuda-12.4-x64.zip' },
    { name: 'llama-b9702-bin-win-cuda-13.3-x64.zip' },
    { name: 'llama-b9702-bin-win-vulkan-x64.zip' },
    { name: 'llama-b9702-bin-ubuntu-x64.tar.gz' },
    { name: 'llama-b9702-bin-ubuntu-vulkan-x64.tar.gz' },
